...
#			--> also possible with SUBSELECT SELECT, 
...
#     2.3 Welcher Autor hat am meisten Downloads? Beachte, dass ein Autor mehrere Bücher haben kann, die entsprechenden Downloads
#         müssen aufsummiert werden - Wichtig: „Various“, NULL, Anonymous,… zählen hierbei nicht als Autor
...
#         In welcher Sprache sollten wir dieses Buch schreiben? Bzw. anders ausgedrückt: Für welche Sprache gibt es aktuell durchschnittlich 
#         die meisten Downloads pro Buch?
